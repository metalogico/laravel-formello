(function() {
    ...
    const engine = {
        form_el: null,
        reactive_map: {},    // { field_name: { client: [...], server: [...] } }
        compute_url: null,
        model_class: null,
        model_id: null,
        debounce_ms: 300,
        ...
        setupListeners() {
            ...
            for (const field_name of Object.keys(this.reactive_map)) {
                ...
                // Text/number/email (debounced)
                wrapper.querySelectorAll('input[type="text"],input[type="number"],input[type="email"],input[type="hidden"],textarea')
                    .forEach(el => {
