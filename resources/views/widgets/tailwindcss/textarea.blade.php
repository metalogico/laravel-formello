<div class="mb-4">
    ...
    <textarea name="{{ $name }}"
        class="mt-1 block w-full rounded-md bg-white text-gray-900 placeholder:text-gray-400 border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition resize-y {{ $errorState }} {{ $config['attributes']['class'] ?? '' }}"
