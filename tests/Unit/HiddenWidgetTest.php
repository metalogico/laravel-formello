...
use Metalogico\Formello\Widgets\HiddenWidget;
...
class HiddenWidgetTest extends TestCase
{
    ...
    private function makeFormWithHiddenWidget()
    {
        return new class($this->makeDummyModel(), new ViewErrorBag()) extends Formello {
            protected function fields(): array {
                return [
                    FormelloField::make('field')->widget('hidden'),
                ];
            }
    ...
    public function test_hidden_widget_is_instantiated_and_renders()
    {
        $form = $this->makeFormWithHiddenWidget();
        $fields = $form->getFields();
        $this->assertArrayHasKey('field', $fields);
        $this->assertInstanceOf(HiddenWidget::class, $fields['field']['widget']);
